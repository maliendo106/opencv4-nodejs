...
// Después de obtener el contorno
const handContourPoints = handContour.getPoints();

// Dibuja el contorno con líneas
for (let i = 0; i < handContourPoints.length - 1; i++) {
  resizedImg.drawLine(handContourPoints[i], handContourPoints[i + 1], blue, 2, cv.LINE_AA);
}
resizedImg.drawLine(handContourPoints[handContourPoints.length - 1], handContourPoints[0], blue, 2, cv.LINE_AA);
